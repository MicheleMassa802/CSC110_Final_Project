"""CSC110 Fall 2020 Course Project: Data Transformation/Formatting

Authors: Michele Massa, Nischal Nair, Nathan Zavys-Cox

Description: this module contains functions that transform, organize and filter the
three required datasets into usable data for our computations.
